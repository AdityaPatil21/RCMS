...
<br><br>
   ...
   <section class="section-news section-t8">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-center">
              <div class="title-box">
                <h4 class="title-a" style="color:#000;">Higher Authority Registration</h4>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-6">      
           <form action="HigherAuthorityRegistrationController" method="post" class="formone">
       ...
       <div class="text-center"> 
          <div class="form-group mt-1">
                    ...
                    <a href="HigherAuthorityLogin.jsp" style="color:red">Login here!!!</a>
       </div>
        </form>
          </div></div>
        <br>
