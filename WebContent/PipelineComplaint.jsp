        ...
        <div class="row">
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-center">
              <div class="title-box">
                <h4 class="title-a" style="color:#fff;">Pipeline Complaint</h4>
              </div>
            </div>
          </div>
         ...
         <center>
         <div class="col-lg-6">
          <form role="form" action="PipelineComplaintCon" method="post" enctype="multipart/form-data">
                            <fieldset>
              ...
              <input type="text" name="location" class="form-control custom-labels" title="" required="required" placeholder="Enter Location" required/>
              </div> 
                      <div class="form-group mt-1">
              <input type="text" name="pincode" class="form-control custom-labels" title="" required="required" placeholder="Enter Pincode" required/>
              </div>
               <div class="form-group mt-1">
              <textarea name="description" class="form-control custom-labels" title="" required="required" placeholder="Enter Description" required></textarea>
              </div>  
                                 <div class="form-group mt-1">
