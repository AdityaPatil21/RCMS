   ...
   <section class="section-news section-t8">
      <div class="container" >
          ...
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-center">
              <div class="title-box">
                <h4 class="title-a" style="color:#000;">Login</h4>
              </div>
            </div>
          </div>
      ...
      <div class="col-lg-6">
       ...
       <div class="text-center"> 
          <div class="form-group mt-1">
                     <button type="submit" style="background-color:#2eca6a; height:40px; width:200px;"><b>Login</b></button>
                    </div><br>
                     <a href="forgotPassword.jsp" style="color:green">Forgot Password?</a>
                    <a href="UserRegistration.jsp" style="color:red">Register here!!!</a>
