                    ...
                    /*  ResultSet rs=st.executeQuery("select * from streetlightcomplaint"); */
                     ...
                     if(rs.next() == false) {
                    	...
                    	<td style="color:white"><%=rs.getString(4) %></td>
                    	 ...
                    	 <th><a style="color:#2eca6a;" href="UpdatePipelineStatusCon?id=<%=rs.getInt(1)%>&status=<%=rs.getString(7)%>"><%=rs.getString(7)%></a></th>
                    	<td><a style="color:red;" href="ReasonPipeline.jsp?id=<%=rs.getInt(1)%>"><b>Reason</b></a></td>
