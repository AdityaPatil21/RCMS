...
<br><br>
   ...
   <section class="section-news section-t8">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-center">
              <div class="title-box">
                <h4 class="title-a" style="color:#000;">Authority Registration</h4>
              </div>
            </div>
          </div>
        <div class="col-lg-6">
        ...
        <div class="col-lg-6">      
           <form action="AuthorityRegistrationController" method="post" class="formone">
       ...
       <div class="text-center"> 
          <div class="form-group mt-1">
                    ...
                    <a href="AuthorityLogin.jsp" style="color:red">Login here!!!</a>
       </div>
        </form>
          </div></div>
        <br>
