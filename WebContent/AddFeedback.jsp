      ...
      <div class="container">
          ...
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-center">
              <div class="title-box">
                <h4 class="title-a" style="color:#fff;">User Feedback Form</h4>
              </div>
            </div>
          </div>
        <div class="row">
        <div class="col-lg-6">
          <img src="assets/img/feedback.png" height="350px;">
          </div>
          
        <div class="col-lg-6">      
           <form action="AddFeedbackController" method="post" class="formone">
           ...
           <div class="form-group mt-1">
           <label style="color:white;">Complaint Agains</label>                 
              <select id="feedbackagains" name="feedbackagains" class="form-control custom-labels">
 		<option>Select Complaint Agains</option>
 		<option value="Authority" style="color: orange;">Authority</option>
 		<option value="HigherAuth" style="color: orange;">HigherAuth</option>
            ...
            <label style="color:white;">Feedback</label>
                <textarea name="feedback" class="form-control" id="feedback" placeholder="Type your feedback here" required></textarea>
              </div>
