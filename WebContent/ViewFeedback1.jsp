    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="AuthorityHome.jsp">Home</a>
          </li>

           <li class="nav-item">
            <a class="nav-link active" href="ViewFeedback1.jsp">View Feedback</a>
          </li>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-center">
              <div class="title-box">
                <h4 class="title-a" style="color:#fff;">View Feedback</h4>
              </div>
            </div>
          </div>
				...
				<div class="row">
                    ...
                    <table class="table table-bordered table-dark" style="color:black" align="center">
                     ...
                     ResultSet rs=st.executeQuery("select * from feedback where feedbackagains='HigherAuth'");
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	...
                    	<td style="color:white"><%=rs.getString(4) %></td>
                    	 ...
                    	 <td><a style="color:red;" href="DeleteFeedbackCon?id=<%=rs.getInt(1)%>"><b>Delete</b></a></td>
                    	 </TR>                    	 
                    <%count++; }while(rs.next());}%> 
