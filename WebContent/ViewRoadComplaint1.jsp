              ...
              <div class="title-box">
				...
				<div class="row">
                    ...
                    /*  ResultSet rs=st.executeQuery("select * from streetlightcomplaint"); */
                     ResultSet rs=st.executeQuery("select roadcomplaint.id,user.name,roadcomplaint.image,roadcomplaint.location,roadcomplaint.pincode, roadcomplaint.description,roadcomplaint.status from roadcomplaint inner join user on roadcomplaint.email=user.email");
