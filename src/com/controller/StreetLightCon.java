...
/**
 * Servlet implementation class StreetLightCon
 */
@MultipartConfig
@WebServlet("/StreetLightCon")
public class StreetLightCon extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (dao.AddStreetLightComplaint(b)) {
			out.println("<script type=\"text/javascript\">");
			out.println("alert('Compaint submitted successfully')");
			out.println("location='StreetLightComplaint.jsp';");
			out.println("</script>");
		} else {
			out.println("<script type=\"text/javascript\">");
