...
/**
 * Servlet implementation class OtherComplaintCon
 */
@MultipartConfig
@WebServlet("/OtherComplaintCon")
public class OtherComplaintCon extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (dao.AddOtherComplaint(b)) {
			out.println("<script type=\"text/javascript\">");
			out.println("alert('Compaint submitted successfully')");
			out.println("location='OtherComplaint.jsp';");
			out.println("</script>");
		} else {
			out.println("<script type=\"text/javascript\">");
